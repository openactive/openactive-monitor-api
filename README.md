...
- `GET /admin/dataset-stall-incidents`: datasets whose feeds have all stopped publishing, freezing everything downstream
- `GET /admin/dataset-stall-trend`: daily open/past-threshold dataset-wide stall counts
